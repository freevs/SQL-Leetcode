...
insert into Weather_1294(country_id, weather_state, day) values(2, 15, '2019-11-01'),
															   (2, 12, '2019-10-28'),
                                                               (2, 12, '2019-10-27'),
                                                               (3, -2, '2019-11-10'),
                                                               (3, 0, '2019-11-11'),
...
select c.country_name, (case when (sum(w.weather_state) / count(w.day) )<= 15 then "Cold"
